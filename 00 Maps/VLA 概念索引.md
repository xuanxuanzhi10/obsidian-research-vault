...
> [!warning] 核实状态
> “待原文 PDF 复核”表示当前只建立了知识链接，不能把具体配置当成已验证事实。现阶段 HyVLA、π₀ 已完成全文与附录核查；π₀.5、OpenVLA 仍需各自 PDF 精读。
...
- [[ALTER]]：怎样把干净示范与部署事件转成阶段内 advantage 文字条件
...
- [[Latent Tactile Token]]：怎样用固定少量 token 预测一个动作块的净接触变化
- [[异步触觉动作细化]]：怎样让慢视觉规划接受高频触觉纠偏
- [[触觉机器人学习]]：按用途、表示、动作接口、融合和验证组织触觉论文
- [[触觉 VLA 方法比较]]：T-Rex、FTP-1、N0-VTLA、N0-TWAM 的互补关系与 HyVLA 组合路线
